...
namespace library
{
	...
	HRESULT SkinningVertexShader::Initialize(_In_ ID3D11Device* pDevice)
	{
		...
		D3D11_INPUT_ELEMENT_DESC aLayouts[] =
		{
			...
			{ "TANGENT", 0, DXGI_FORMAT_R32G32B32_FLOAT, 1, 0, D3D11_INPUT_PER_VERTEX_DATA, 1 },
			{ "BITANGENT", 0, DXGI_FORMAT_R32G32B32_FLOAT, 1, D3D11_APPEND_ALIGNED_ELEMENT, D3D11_INPUT_PER_VERTEX_DATA, 1 },
